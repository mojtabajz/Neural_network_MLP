...
def func(domain):
    pi=math.pi
    result = [ i+6+10*random.random() for i in domain]
    # result = [((i*2+i*3)/2)*10*random.random() for i in domain]
    # result = [math.sin(i/7)*5*10*random.random() for i in domain]
    # result = [ math.sin(2*i*pi)+math.sin(5*i*pi)+ 10*random.random() for i in domain]
